...
struct TerminalColors {
    ...
    // MARK: - Semantic Aliases (bridging to DesignTokens)
    ...
    static let surfaceHover = DesignTokens.Surface.hover
    static let borderSubtle = DesignTokens.Border.subtle
    static let borderStandard = DesignTokens.Border.standard
}
