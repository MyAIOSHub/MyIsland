...
extension Notification.Name {
    static let updateAvailableNotification = Notification.Name("MyIslandUpdateAvailable")
    static let updateReadyToInstallNotification = Notification.Name("MyIslandUpdateReadyToInstall")
}
...
class UpdateManager: NSObject, ObservableObject {
    ...
    func updateFound(version: String, releaseNotes: String?, installHandler: @escaping (SPUUserUpdateChoice) -> Void) {
        ...
        if !hasSeenUpdateThisSession {
            ...
            // Proactively expand notch to show update notification
            NotificationCenter.default.post(name: .updateAvailableNotification, object: nil)
        }
    }
